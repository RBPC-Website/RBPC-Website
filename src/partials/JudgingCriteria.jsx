...
function JudgingCriteria() {
    ...
    const textStyle = 'absolute font-medium h5 w-2/5';
            ...
            <div className='content'>
                ...
                <div className="w-full py-10 pb-24">
                    ...
                    <div className='relative hidden md:block w-[70%]'>
                        ...
                        <p className={`${textStyle} left-[98%] top-[66%]`}>{t("feasibilityViability")}</p>
                    ...
                    <div className='md:hidden'>
                        {/* Header */}
                        <h1 className='capitalize text-center text-green-100 whitespace-pre-line leading-[120%] h1'>{t("judgingCriteria")}</h1>
                        {/* Contents */}
