        ...
        <div className="content">
            ...
            <div className="bg-gray-100 flex flex-wrap items-center justify-between gap-4 py-6">
                <div className="flex flex-col items-center sm:items-start gap-2 w-full sm:w-[50%] sm:min-w-[270px]">
                    <a className="text-gray-500 hover:text-black-200 hover:underline flex items-center justify-between gap-2">
                        <span className="flex justify-center items-center text-gray-500 hover:text-black-200 bg-gray-100 hover:bg-white-100 p-2 rounded-full shadow transition duration-150 ease-in-out">
