        ...
        <section className="relative bg-black-100 lg:px-20 md:px-20 -mt-1 px-7 pb-20">
            ...
            */}
            ...
            <div className='phase-1 relative md:px-16 pl-12 py-12'>
                {/* Phase Title */}
                <h2 className='text-transparent bg-clip-text bg-gradient-to-t from-green-100 to-green-200 h2 pb-4 align-middle' data-aos="fade-right" data-aos-offset="400" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    {t("preliminaryWorkshop")}
                </h2>
                {/* Phase button */}
            ...
            <div className='relative xl:-mt-[1.6px] md:-mt-[1.8px] -mt-[1.6px] phase-2 text-right md:px-16 pr-12 py-12'>
                {/* Phase Title */}
                <h2 className='text-transparent bg-clip-text bg-gradient-to-t from-green-100 to-green-200 h2 pb-4' data-aos="fade-left" data-aos-offset="400" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    {t("preliminarySemiFinal")}
                </h2>
                {/* Phase button */}
            ...
            <div className='relative xl:-mt-[1.6px] md:-mt-[1.8px] -mt-[1.6px] phase-3 md:px-16 pl-12 py-12'>
                {/* Phase Title */}
                <h2 className='text-transparent bg-clip-text bg-gradient-to-t from-green-100 to-green-200 h2 pb-4' data-aos="fade-right" data-aos-offset="400" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    {t("mentoringWorkshops")}
                </h2>
                {/* Phase button */}
                <div className='absolute bg-black-100 top-11 left-0 flex content-center transform translate-x-[-50%] h-[60px] w-[40px]'>
