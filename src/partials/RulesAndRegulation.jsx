...
function RulesAndRegulation() {
    ...
    return (
        <section id="rules" className="relative bg-black-100"  data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-anchor-placement="top-bottom">
            {/*
            ...
            */}
            ...
            <div className='bg-gray-100'>
                <div className='flex justify-center flex-col gap-10 content py-10'>
