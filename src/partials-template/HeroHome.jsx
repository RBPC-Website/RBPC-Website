...
import HeroImage from '../images/rmit-placeholder.jpeg';
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">
              RMIT BUSINESS PLAN <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">COMPETITION</span>
            </h1>
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              ...
              >
                ...
                <span className="ml-3">{t("video")}</span>
              </button>
            </div>
