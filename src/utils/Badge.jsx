...
export default function Badge( { children, index = 1 } ) {
    return (
        <div className="relative inline-flex items-center p-3 p text-black-200 text-center bg-gray-100 rounded-lg shadow-md shadow-gray-200/40 justify-center leading-snug">
            ...
            <div className="absolute inline-flex items-center justify-center w-8 h-8 text-base bg-green-100 border-gray-100 rounded-full -top-3 -left-3 font-semibold">{index}</div>
        </div>
    )
}
