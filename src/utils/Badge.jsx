...
export default function Badge( { children, index = 1 } ) {
    return (
        <div className="relative inline-flex items-center p-3 text-sm font-medium text-center text-black-100 bg-gray-100 rounded-lg shadow-md shadow-gray-200/40 justify-center">
