...
export default function PoJCard({ cardImage, name, description, school }) {
    return (
        <div className="keen-slider__slide number-slide1 rounded-[30px] overflow-hidden">
            ...
            <div className="h-full w-full absolute left-0 flex flex-col rounded-[30px] overflow-hidden justify-end bottom-0 top-0 right-0 bg-gradient-to-b from-[rgba(0,0,0,0)] via-[rgba(0,0,0,0.2)] to-[rgba(0,0,0,0.76)] px-[20px] py-8">
